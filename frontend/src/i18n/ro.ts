...
export default {
  ...
  lbl_standby_enabled: 'Mod standby',
  hint_standby_enabled: 'După o perioadă de inactivitate, afișează un ecran întunecat cu ceasul care se mișcă pentru a preveni arderea imaginii pe ecran.',
  lbl_standby_timeout: 'Întârziere standby',
  opt_standby_1min: '1 minut',
  opt_standby_3min: '3 minute',
  opt_standby_5min: '5 minute',
  opt_standby_10min: '10 minute',
  opt_standby_15min: '15 minute',
  opt_standby_30min: '30 minute',
  standby_title: 'Standby',
  standby_tap_to_wake: 'Atingeți oriunde pentru a reactiva',
  lbl_weather_city: 'Oraș',
  lbl_weather_units: 'Unități',
  lbl_weather_update: 'Actualizare (minute)',
  lbl_ai_enabled: 'Activează asistentul AI',
  hint_ai_enabled: 'Când este dezactivat, butonul și fereastra de chat AI sunt ascunse.',
  lbl_ai_provider: 'Furnizor AI',
  ...
  lbl_api_key: 'Cheie API',
  hint_cloud_privacy: 'Acesta este un furnizor cloud: mesajele tale sunt trimise pe serverele lui pentru procesare. Nimic nu părăsește dispozitivul cât timp este selectat Ollama (local).',
  ...
  lbl_voice_mic: 'Microfon',
  opt_voice_mic_auto: '— automat (implicit sistem) —',
  hint_voice_mic: 'Alege microfonul de pe server (RPi). Pentru un microfon USB selectează intrarea „USB".',
  ...
  lbl_tuya_enabled: 'Activează Tuya',
  hint_tuya_enabled: 'Când este dezactivat, butonul de temperaturi Tuya este ascuns.',
  ...
  radio_cast_searching: 'Se caută boxe…',
  radio_cast_none_found: 'Nicio boxă Cast găsită',
  radio_retry: 'Reîncearcă',
  radio_cast_unavailable: 'indisponibilă',
  ...
  radio_np_press_play_on: 'Apăsați play pentru a reda pe {name}',
